...
// Replace this with your actual server IP or domain
const API_URL = 'http://localhost:3000'; // TODO: Move this to environment variable
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      {error ? (
        ...
        <>
          ...
          <Text style={styles.info}>{t('profile.joined')}: {new Date(userData?.createdAt || '').toLocaleDateString()}</Text>
          <Button mode="contained" onPress={handleSignOut} style={styles.button}>
            {t('profile.signOut')}
          </Button>
        </>
